    ...
    return (
        <div className='h-container'>
            <div className='h-container1'>
                {
                    ...
                    data1.map((data) => (
                        <div key={data.id} className='h-top-offers'>
            ...
            <div style={{border:"2px solid red"}}>
                <div style={{backgroundImage:`url(${img1})`,height:"150px",backgroundSize:"cover",backgroundPosition:"center",textAlign:"center",paddingTop:"30px"}}>
